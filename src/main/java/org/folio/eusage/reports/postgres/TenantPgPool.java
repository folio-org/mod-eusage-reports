...
public class TenantPgPool implements PgPool {

  private static final Logger log = LogManager.getLogger(TenantPgPool.class);
  ...
  public static void setDefaultConnectOptions(PgConnectOptions connectOptions) {
    TenantPgPool.pgConnectOptions = connectOptions;
  }

  public static void setModule(String module) {
    TenantPgPool.module = module != null ? sanitize(module) : null;
  }
  ...
  public static TenantPgPool tenantPgPool(Vertx vertx, String tenant) {
    ...
    TenantPgPool tenantPgPool = new TenantPgPool();
